...
public class Banco
{
	...
	{
		Agencia a = new Agencia("" + numeroProximaAgencia++, this, 100);
	...
	private boolean adicionaArrayAgencias(Agencia ag)
	{
		...
		{
			System.out.println(
					"Banco ERROR: Nao foi possivel criar uma nova agencia");
			return false;
		} else
		{
			System.out.println("Banco DEBUG: Agencia adicionada ao array "
					+ numAgenciasAbertas);
