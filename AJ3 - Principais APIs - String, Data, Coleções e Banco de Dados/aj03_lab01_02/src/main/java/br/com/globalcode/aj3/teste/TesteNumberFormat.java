...
public class TesteNumberFormat
{
	...
	public static void main(String[] args)
	{
		...
		NumberFormat formatadorNumero = NumberFormat.getNumberInstance(localidade);
		NumberFormat formatadorMoeda = NumberFormat.getCurrencyInstance(localidade);
		NumberFormat formatadorPercent = NumberFormat.getPercentInstance(localidade);

		System.out.println("Resultados:\n");

		// b) Aplique o formatador na impressao dos valores a seguir.
		System.out.println("Rendimento Bruto -> " + formatadorMoeda.format(investimento.getRendimentoBruto()));
		System.out.println("Rendimento Liquido -> " + formatadorMoeda.format(investimento.getRendimentoLiquido()));
		System.out.println(
				investimento.getNomeImposto() + " -> " + formatadorPercent.format(investimento.calcularImpostos()));
	}
}
