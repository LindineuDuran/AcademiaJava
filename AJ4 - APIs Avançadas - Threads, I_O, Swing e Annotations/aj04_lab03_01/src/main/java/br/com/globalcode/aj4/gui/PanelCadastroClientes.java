...
public class PanelCadastroClientes extends JPanel
{
	...
	/**
	 * Metodo utilizado internamente para montagem do JPanel com o botao Salvar, por isto ele foi declarado como private.
	 *
	...
	/**
	 * Metodo utilizado internamente para fazer a escrita dos dados do cliente dentro dos JTextFields referentes aos dados
	 * do cliente, cria um objeto da classe Cliente e retorna o Cliente.
	 *
	...
	class SalvarClienteHandler extends MouseAdapter
	{
		...
		public void mouseClicked(MouseEvent arg0)
		{
			...
			try
			{
				...
				SalvarCliente salvar = new SalvarCliente(cliente);
				Thread t = new Thread(salvar);
				t.start();
			...
			try
			{
				...
				SwingUtilities.invokeLater(new Runnable()
				{
					...
					public void run()
					{
						...
						{
							/*****************************************
							 * Implementar a atualizacao dos elementos de tela aqui
							 ****************************************/
