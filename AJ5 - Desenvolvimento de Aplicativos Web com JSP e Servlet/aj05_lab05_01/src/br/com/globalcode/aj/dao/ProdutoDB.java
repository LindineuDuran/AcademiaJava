...
public class ProdutoDB implements ProdutoDAO
{
	...
	public void createTable() throws GlobalcodeException
	{
		...
		try
		{
			...
			Produto[] produtos = { new Produto(86, "Maquina fotografica", "maqFot001", "Maquina fotografica", 80, "maqFot001.gif"), new Produto(85, "CD - Meu Reino Encantado", "cd003", "Daniel", 18, "cd003.gif"), new Produto(82, "TV 29",
					"tv29philips", "29' Tela Plana", 1750,
					"tv001.gif"), new Produto(83, "CD - As Gargantas do Brasil", "cd001", "Milionario e Jose Rico", 13, "cd001.gif"), new Produto(79, "CD - Ta Nervoso...Vai Pesca", "cd002", "Ataide & Alexandre", 15, "cd002.gif") };
