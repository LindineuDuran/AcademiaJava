...
public class ClientesDAOImpl implements IClientesDAO
{
	...
	{
		/*
		 * Obter todos os clientes do banco de dados usando a constante GET_ALL_CLIENTES
		 */
		...
		// Criar ResultSet para guardar o resultado da consulta
		ResultSet rs = null;
		...
		{
			throw new GlobalcodeException("Erro ao retornar lista de clientes: " + GET_ALL_CLIENTES, e);
		}
		finally
		{
