...
import br.com.globalcode.dao.ClientesDAOImpl;
import br.com.globalcode.dao.IClientesDAO;
...
public class TesteClientesDAO
{
	...
	/**
	 * Este metodo e reponsavel pela montagem do menu de op�oes do usuario: INSERIR
	 * | REMOVER | LISTAR | FINALIZAR
	 */
	...
	/**
	 * Este metodo e reponsavel por ler um cliente digitado pelo usuario, fazendo
	 * todas as "perguntas / intera�oes" necessarias para obten�ao dos dados
	 * digitados.
	 */
	...
	/**
	 * Este metodo e reponsavel por ler o ID de um cliente digitado pelo usuario,
	 * fazendo todas as "perguntas / intera�oes" necessarias para obten�ao dos dados
	 */
