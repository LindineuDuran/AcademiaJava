...
public class ClientesDAO implements IClientesDAO
{
	...
	private final static String CREATE_TABLE = "CREATE TABLE  IF NOT EXISTS  clientes (id int(3) NOT NULL AUTO_INCREMENT   PRIMARY KEY, nome VARCHAR(50) NOT NULL, cpf varchar(20) NOT NULL, telefone varchar(20) NOT NULL)";
	...
	/*
	 * @see br.com.globalcode.aj4.dao.ClientesDAO#excluir(br.com.globalcode.beans
	 * .Cliente)
	 */
	@Override
	...
	/*
	 * @see br.com.globalcode.aj4.dao.ClientesDAO#salvar(br.com.globalcode.beans.
	 * Cliente)
	 */
	@Override
	...
	public List<Cliente> getAllClientes() throws GlobalcodeException
	{
		...
		try
		{
			...
			while (rs.next())
			{
				Cliente cli = new Cliente(rs.getString("nome"), rs.getString("telefone"), rs.getString("cpf"),
						rs.getInt("id"));
				clientes.add(cli);
			}
		}
