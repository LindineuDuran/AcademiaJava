...
public class PainelCadastroClientes extends JPanel
{
	 ...
	 * JTextFields. Os dados lidas dos campos de texto sao usados para criar um
	...
	private Cliente loadClienteFromPanel() throws GlobalcodeException
	{
		 ...
		 * getText(). Armazene cada dado lido em uma variavel para usar posteriormente.
		 */
		...
		/*
		 * b) Instancie um objeto do tipo Cliente usando os dados lidos dos JTextFields
		 * e retorne este objeto como resultado do metodo.
		 */
		Cliente clie = new Cliente(nome, telefone, cpf);
		return clie;
	}

	/**
	 * Metodo utilizado internamente para fazer a limpeza dos JTextFields dos dados
	 * do cliente.
	 */
	...
	/**
	 * Metodo utilizado internamente para atribuir aos JTextField, os dados de um
	 * objeto Cliente.
	 *
	 * @param cliente cliente a ser apresentado na tela
	 */
	private void loadClienteToPanel(Cliente c)
	{
		...
		{
			/*
			 * d) Obtenha os dados do objeto Cliente recebido como parametro e atribua aos
			 * JTextFields para apresentar os dados do cliente na tela (use o metodo setText
			 * do JTextField).
			 */
	...
	class SalvarClienteListener extends MouseAdapter
	{
		 ...
		 *
		 * Esse handler deve acionar o metodo loadClienteFromPanel para guardar os dados
		 * da tela no objeto Cliente.
		 *
		...
		public void mouseClicked(MouseEvent e)
		{
			try
			{
				Cliente clie = loadClienteFromPanel();
