package br.com.season.java8_lab06.solution;
...
/**
 * a. Get student with exact match name "jayesh" b. Get student with matching
 * address "1235" c. Get all student having mobile numbers 3333. d. Get all
 * student having mobile number 1233 and 1234 e. Create a List<Student> from the
 * List<TempStudent> f. Convert List<Student> to List<String> of student name g.
 * Convert List<students> to String h. Change the case of List<String> i. Sort
 * List<String> j. Conditionally apply Filter condition, say if flag is enabled
 * then.
 *
 */
